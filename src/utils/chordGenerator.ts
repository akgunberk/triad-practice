...
const PROGRESSION_ROMAN_NUMERALS: Record<
  Exclude<ProgressionMode, "random">,
  string[]
> = {
  "I-IV-V": ["I", "IV", "V"],
  "II-V-I": ["IIm", "V", "I"],
...
export function getProgressionChord(progressionState: ProgressionState): Chord {
...
export function generateRandomChord(
  ...
  const types =
    selectedTypes && selectedTypes.length > 0 ? selectedTypes : TRIAD_TYPES;
